...
//        2. GET PREPARED STATEMENT
            ...
            String sql = "select b.id,\n" +
                    ...
                    "group by b.id, c.id, c.name, b.title, b.\"imgUrl\"\n" +
                    "limit ? offset ? * (? - 1)";
...
//        2. GET PREPARED STATEMENT
            ...
            String sql = "select b.id,\n" +
                    ...
                    "group by b.id, c.id, c.name, b.title, b.\"imgUrl\", b.year, b.quantity, b.description, b.isbn\n";
...
//            3. GET RESULTSET
    ...
    public static boolean addNewBook(Book book) {
        ...
        try {
            ...
            String insertBook = "insert into books (title, description, categoryId, \"imgUrl\",year,isbn,quantity) VALUES " +
                    "(?, ?, ?, ?,?,?,?)";
