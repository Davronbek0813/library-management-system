...
<div class="card">
    ...
    <div class="button-container"><span><a href="/add-user" >ADD USER</a></span>
        ...
        <table>
            ...
            <c:forEach var="userlist" items="${list}">
                <tr>
                    ...
                    <td class="danger"><button class="danger"><a href="/delete-user?id=${userlist.getId()}"> DELETE</a></button></td>
                    <td class="danger"><button class="danger"><a href="/update-user?id=${userlist.getId()}"> UPDATE</a></button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
