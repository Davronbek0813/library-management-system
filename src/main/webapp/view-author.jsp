...
<div class="card">
    ...
    <div class="button-container"><span><a href="/add-author" >ADD AUTHOR</a></span>
    ...
    <div class="table-concept">
        ...
        <table>
            ...
            <c:forEach var="authorlist" items="${list}">
                <tr>
                    <td>
                        <input type="checkbox"/>
                    </td>
                    <td>${authorlist.getId()}</td>
                    <td>${authorlist.getFullName()}</td>
                    <td class="danger"><button class="danger"><a href="/delete-author?id=${authorlist.getId()}"> DELETE</a></button></td>
                    <td class="danger"><button class="danger"><a href="/update-author?id=${authorlist.getId()}"> UPDATE</a></button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
