...
<div class="card">
    ...
    <div class="button-container"><span><a href="/add-category" >ADD CATEGORY</a></span>
        ...
        <table>
            ...
            <c:forEach var="categorylist" items="${list}">
                <tr>
                    ...
                    <td>${categorylist.getId()}</td>
                    <td>${categorylist.getName()}</td>
                    <td class="danger"><button class="danger"><a href="/delete-category?id=${categorylist.getId()}"> DELETE</a></button></td>
                    <td class="danger"><button class="danger"><a href="/update-category?id=${categorylist.getId()}"> UPDATE</a></button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
